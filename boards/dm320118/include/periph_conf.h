/*
 * Copyright (C) 2023 Francisco Javier Acosta Padilla <francisco.acosta@instagrid.co>
 *
 ...
 *
 * @file
 * @brief       Configuration of CPU peripherals for the DM320118 CryptoAuth Trust Platform
 *              development kit
 *
...
#if PWM_0_EN
/* PWM0 channels (mikroBUS Header) */
static const pwm_conf_chan_t pwm_chan0_config[] = {
    /* GPIO pin, MUX value, TCC channel */
    { .pin = GPIO_PIN(PA, 10), .mux = GPIO_MUX_E, .chan = 0 },
};
#endif
...
static const adc_conf_chan_t adc_channels[] = {
    /* port, pin, muxpos */
    { .inputctrl = ADC_INPUTCTRL_MUXPOS_PA04 },      /* mikroBUS Header, pin 1 */
};
